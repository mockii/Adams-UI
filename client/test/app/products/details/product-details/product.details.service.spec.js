...
describe('ProductDetailsService', function(){
    ...
    beforeEach(module('adams.products.product.details.service'));

    beforeEach(inject(function($rootScope, _$httpBackend_, ProductDetailsService, _$q_, ADAMS_URL_SPACE, $log){
        scope = $rootScope;
        $httpBackend = _$httpBackend_;
        sampleSvcObj = ProductDetailsService;
        $q = _$q_;
    ...
    it('should getProductDetails  Info', function(){
        var productNumber = '100',
            url = urlSpace.urls.local.productDetails + '?productNumber=' + productNumber;
        var responseData = {
            data: {
                data: [{}]
            }
        ...
        sampleSvcObj.getProductDetails (productNumber).then(function(response) {

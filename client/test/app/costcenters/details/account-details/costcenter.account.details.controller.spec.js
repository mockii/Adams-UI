...
describe('CostCenterAccountDetailsController', function() {
    ...
    beforeEach(inject(function (_$state_, _$location_, $controller, _$rootScope_, _$interval_, _$q_, _$httpBackend_, CostCenterDetailsService) {
        ...
        Ctrl = $controller('CostCenterAccountDetailsController', {$state: $state, $scope: $scope, $location: $location, CostCenterDetailsService: CostCenterDetailsService, costCenterSearchData: costCenterSearchData});
    }));

    it('should initialize the CostCenterAccountDetailsController properly', function () {

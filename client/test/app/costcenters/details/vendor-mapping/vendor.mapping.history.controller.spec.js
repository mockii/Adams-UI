...
describe('VendorMappingHistoryController', function() {
    var Ctrl,
        Ctrl2,
        // Ctrl3,
        $scope,
    ...
    beforeEach(module('adams.vendor.mapping.history.controller'));
    ...
    beforeEach(inject(function($controller, $state, _$compile_, _$rootScope_, _$httpBackend_, _$uibModal_, _$filter_, _$timeout_, VendorMappingService, _$q_, ADAMS_URL_SPACE, ADAMS_CONSTANTS, CompassToastr, Utils){
        ...
        mockVendorService.getVendorMappingHistoryData = function(limit, page, sort, gridSearchParams, vendorRowData) {
            var deferred = $q.defer();
            deferred.resolve(callWith);
            return deferred.promise;
        };

        mockVendorService2.getVendorMappingHistoryData = function(limit, page, sort, gridSearchParams, vendorRowData) {
            var deferred = $q.defer();
        ...
        Ctrl = $controller('VendorMappingHistoryController', { $scope: $scope, $state: $state, $timeout:$timeout, vendorRowData: vendorRowData, $uibModalInstance: $uibModalInstance, $uibModal: $uibModal, compassToastr: CompassToastr, ADAMS_CONSTANTS: adamsConstants,  ModalDialogService: mockModalDialogService, VendorMappingService: mockVendorService, Utils: mockUtils,  mockModal: mockModal});

        Ctrl2 = $controller('VendorMappingHistoryController', { $scope: $scope, $state: $state, $timeout:$timeout, vendorRowData: vendorRowData, $uibModalInstance: $uibModalInstance, $uibModal: $uibModal, compassToastr: CompassToastr, ADAMS_CONSTANTS: adamsConstants,  ModalDialogService: mockModalDialogService, VendorMappingService: mockVendorService2, Utils: mockUtils,  mockModal: mockModal});

        // Ctrl3 = $controller('VendorMappingHistoryController', { $scope: $scope, $state: $state, $timeout:$timeout, vendorRowData: vendorRowData, $uibModalInstance: $uibModalInstance, $uibModal: $uibModal, compassToastr: CompassToastr, ADAMS_CONSTANTS: adamsConstants,  ModalDialogService: mockModalDialogService, VendorMappingService: mockVendorService3, Utils: mockUtils,  mockModal: mockModal});
    }));

    it('should initialize the VendorMappingHistoryController properly', function () {
    ...
    /*it('should call getVendorMappingHistoryData with result', inject(function () {
        var vendorResponse;
        var deferred = $q.defer();
        ...
        var promise = mockVendorService.getVendorMappingHistoryData();
    ...
    /*it('should call getVendorMappingHistoryData with response error', function () {
        //$scope.$apply();

...
describe("adams.common.jobs.grid.controller", function () {
    ...
    beforeEach(module('adams.common.jobs.grid.controller'));
    ...
    beforeEach(inject(function($controller,  _$rootScope_, _$q_, _ADAMS_CONSTANTS_, _AssociatesSearchService_, _$timeout_, Utils) {
        ...
        mockedAssociatesSearchService.getAllJobs = function(pageSize, pageNumber, sort, search, fields) {
            var deferred = $q.defer();
            deferred.resolve({});
        ...
        controller = $controller('JobsGridController',
            {$rootScope : $rootScope,
                $state : state,
                $scope: scope,

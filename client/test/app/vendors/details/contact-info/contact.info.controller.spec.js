...
describe('ContactInfoController', function() {
    ...
    beforeEach(inject(function($controller, $state, _$compile_, _$rootScope_, _$httpBackend_, _$uibModal_, _$filter_, $timeout, ContactInfoService, _$q_, ADAMS_URL_SPACE, ADAMS_CONSTANTS, CompassToastr, Utils, STGLogService, $log){
        ...
        /*mockModal = {
            ...
            /!*open: jasmine.createSpy('mockModal.open').and.returnValue(function() {
                return this.result;
            }),
            result: {
        ...
        //mockContactInfoGridPromise = jasmine.createSpyObj('contactInfoGridPromise', ['abort']);
        mockContactInfoGridPromise = {
            abort: function() {}
        };
        ...
        mockContactInfoService3.deleteContactInfo = function(){
            var deferred = $q.defer();
            deferred.reject({});
            deferred.promise.abort = function(){};
            return deferred.promise;
        ...
        /*delcont = jasmine.createSpy('gridApi.grid.appScope');

        delcont.deleteContactInfo = function(contactInfoRowData) {return {};};

        delcont.editContactInfo = function(contactInfoRowData) {return {};};*/



        Ctrl = $controller('ContactInfoController', { $scope: $scope, $state: $state, $timeout:$timeout, ContactInfoService: mockContactInfoService, ModalDialogService: mockModalDialogService, compassToastr: CompassToastr, $uibModal: mockModal,  ADAMS_CONSTANTS: adamsConstants, Utils: mockUtils, contactInfoGridPromise: mockContactInfoGridPromise, vendorSearchData: vendorSearchData});
        ...
        Ctrl3 = $controller('ContactInfoController', { $scope: $scope, $state: $state, $timeout:$timeout, ContactInfoService: mockContactInfoService3, ModalDialogService: mockModalDialogService, compassToastr: CompassToastr, $uibModal: mockModal,  ADAMS_CONSTANTS: adamsConstants, Utils: mockUtils, contactInfoGridPromise: mockContactInfoGridPromise, vendorSearchData: vendorSearchData});
    }));
    ...
    it('should call deleteContactInfoFunction else block and throw error', function() {
        spyOn(Ctrl3, 'deleteContactInfoFunction').and.callThrough();
        Ctrl3.deleteContactInfoFunction(contactInfoRowData);
        $scope.$apply();
        expect(Ctrl3.deleteContactInfoFunction).toHaveBeenCalled();
    });
    ...
    it('should notify boolean - Yes', function () {
        var value = true, result;
        result = $filter('notifyFilter')(value);
        expect(result).toEqual('Yes');
    });

    it('should notify boolean - No', function () {

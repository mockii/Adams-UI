...
describe('CostCenterMappingDisAssociateEdiReasonController', function () {
    var Ctrl,
    ...
    beforeEach(module('adams.cost.center.mapping.disassociate.edi.reason.controller'));
    ...
    beforeEach(inject(function ($controller, $rootScope, ADAMS_CONSTANTS) {
        ...
        Ctrl = $controller('CostCenterMappingDisAssociateEdiReasonController', {
            $scope: $scope,
            $state: $state,
    ...
    it('should initialize the CostCenterMappingDisAssociateEdiReasonController properly', function () {

...
describe('CostCenterMappingDisAssociateController', function () {
    var Ctrl,
    ...
    beforeEach(inject(function ($controller, $rootScope, ADAMS_CONSTANTS) {
        ...
        Ctrl = $controller('CostCenterMappingDisAssociateController', {
            $scope: $scope,
            $state: $state,
    ...
    it('should initialize the CostCenterMappingDisAssociateController properly', function () {

...
describe('LocationsStationsStatusChangeController', function () {
    var Ctrl,
    ...
    beforeEach(module('adams.locations.stations.status.change.controller'));
    ...
    beforeEach(inject(function ($controller, $rootScope, ADAMS_CONSTANTS) {
        ...
        Ctrl = $controller('LocationsStationsStatusChangeController', {
            $scope: $scope,
            $state: $state,
    ...
    it('should initialize the LocationsStationsStatusChangeController properly', function () {

...
describe('LocationsAddCostCenterMappingController', function() {
    var Ctrl,
        Ctrl2,
        Ctrl3,
        Ctrl4,
        ...
        mockLocationsCostCenterMappingService3 = {},
        mockLocationsCostCenterMappingService4 = {},
        mockLocationsCostCenterMappingService5 = {},
        mockLocationsCostCenterMappingService6 = {},
        $rootScope,
        $httpBackend,
        $q,
        $uibModalInstance,
    ...
    beforeEach(module('adams.locations.add.cost.center.mapping.controller'));
    ...
    beforeEach(function() {
        module(function ($provide) {
            ...
            $provide.value('LocationsCostCenterMappingService', mockLocationsCostCenterMappingService2);
            $provide.value('LocationsCostCenterMappingService', mockLocationsCostCenterMappingService3);
              /*$provide.value('LocationsCostCenterMappingService', mockLocationsCostCenterMappingService4);
            $provide.value('LocationsCostCenterMappingService', mockLocationsCostCenterMappingService5);
            $provide.value('LocationsCostCenterMappingService', mockLocationsCostCenterMappingService6);*/
    ...
    beforeEach(inject(function($controller, _$rootScope_, _$httpBackend_, _$timeout_, LocationsCostCenterMappingService, _$q_, ADAMS_URL_SPACE, ADAMS_CONSTANTS, CompassToastr, Utils, STGLogService, $log){
        ...
        mockLocationsCostCenterMappingService.getCostCentersByUserName = function(limit, page, sort, search) {
            var deferred = $q.defer();
        ...
        mockLocationsCostCenterMappingService2.getEligibleCostCenterData = function(limit, page, sort, vendorNumber, vendorSourceSystemId) {
            var deferred = $q.defer();
            deferred.resolve('error');
            return deferred.promise;
        };

        mockLocationsCostCenterMappingService3.getEligibleCostCenterData = function(limit, page, sort, vendorNumber, vendorSourceSystemId) {
            var deferred = $q.defer();
            deferred.reject({});
            return deferred.promise;
        };

        mockLocationsCostCenterMappingService.addCostCentersByLocationCode = function(locationCode, costCentersData) {
            var deferred = $q.defer();
            deferred.resolve({"metadata":{"version":"1.0.0","status":"Success","http_status_code":"200","resultCount":"2"},"data":[{"vendor_number":"10016011","vendor_name_1":"VSA OF OHIO","cost_center_name":"11889","cost_center_description":"$$$Wal-Mart-Shelby","action":"ASSOCIATED","message":"Initial Creation","user_name":"CHOUHR01","first_name":"RAKESH","last_name":"CHOUHAN","email":"DO_NOT_REPLY_RAKESH.CHOUHAN@COMPASS-USA.COM","phone_number":null,"action_date":"12-14-2016 20:30","vendor_source_system_id":1001,"cost_center_source_system_id":1001},{"vendor_number":"10016011","vendor_name_1":"VSA OF OHIO","cost_center_name":"11889","cost_center_description":"$$$Wal-Mart-Shelby","action":"UPDATED","message":"UPDATED","user_name":"CHOUHR01","first_name":"RAKESH","last_name":"CHOUHAN","email":"DO_NOT_REPLY_RAKESH.CHOUHAN@COMPASS-USA.COM","phone_number":null,"action_date":"12-14-2016 20:39","vendor_source_system_id":1001,"cost_center_source_system_id":1001}],"error":"{}"});
            return deferred.promise;
        };

        mockLocationsCostCenterMappingService2.addCostCentersByLocationCode = function(locationCode, costCentersData) {
            var deferred = $q.defer();
            deferred.resolve('error');
            return deferred.promise;
        };

        mockLocationsCostCenterMappingService3.addCostCentersByLocationCode = function(locationCode, costCentersData) {
            var deferred = $q.defer();
            deferred.reject({});
            return deferred.promise;
        };
        ...
        Ctrl = $controller('LocationsAddCostCenterMappingController', { $scope: $scope, $state: $state, $uibModalInstance: $uibModalInstance, $timeout: _$timeout_, compassToastr: CompassToastr, ADAMS_CONSTANTS: adamsConstants,  ModalDialogService: mockModalDialogService, addEligibleCostCenterData: addEligibleCostCenterData, LocationsCostCenterMappingService: mockLocationsCostCenterMappingService, Utils: mockUtils, mockModal: mockModal});
        Ctrl2 = $controller('LocationsAddCostCenterMappingController', { $scope: $scope, $state: $state, $uibModalInstance: $uibModalInstance, $timeout: _$timeout_, compassToastr: CompassToastr, ADAMS_CONSTANTS: adamsConstants,  ModalDialogService: mockModalDialogService, addEligibleCostCenterData: addEligibleCostCenterData, LocationsCostCenterMappingService: mockLocationsCostCenterMappingService2, Utils: mockUtils, mockModal: mockModal});
        Ctrl3 = $controller('LocationsAddCostCenterMappingController', { $scope: $scope, $state: $state, $uibModalInstance: $uibModalInstance, $timeout: _$timeout_, compassToastr: CompassToastr, ADAMS_CONSTANTS: adamsConstants,  ModalDialogService: mockModalDialogService, addEligibleCostCenterData: addEligibleCostCenterData, LocationsCostCenterMappingService: mockLocationsCostCenterMappingService3, Utils: mockUtils, mockModal: mockModal});
    }));

    it('should initialize the LocationsAddCostCenterMappingController properly', function () {
        ...
        //expect(function() {mockLocationsCostCenterMappingService3.getEligibleCostCenterData()}).toThrowError("An error occurred while getting eligible cost center  data");
        //expect(function() {mockLocationsCostCenterMappingService3.addCostCenterMapping()}).toThrowError("An error occurred while adding eligible cost center mapping data");
    });
   ...
   it('should verify the Grid Option Pagination Page Size', function () {
    ...
    it('should call select with response', function () {
        ...
        // expect(function() {mockLocationsCostCenterMappingService.getEligibleCostCenterData()}).toThrowError("An error occurred while getting eligible cost center  data");
    });
    ...
    /*it('should call select with response and throw error ', inject(function ($q, $rootScope, $controller) {
        mockLocationsCostCenterMappingService3.addCostCenterMapping = function(vendorNumber, vendorSourceSystemId, costCentersData) {
            var deferred = $q.defer();
            deferred.reject({});
            return deferred.promise;
        };

        Ctrl3 = $controller('LocationsAddCostCenterMappingController', { $scope: $scope, $state: $state, $uibModalInstance: $uibModalInstance, $timeout: $timeout, compassToastr: CompassToastr, ADAMS_CONSTANTS: adamsConstants,  ModalDialogService: mockModalDialogService, addEligibleCostCenterData: addEligibleCostCenterData, LocationsCostCenterMappingService: mockLocationsCostCenterMappingService3, Utils: mockUtils, mockModal: mockModal});
        ...
        var addCostCenterMappingPromise = mockLocationsCostCenterMappingService.addCostCenterMapping(vendorData.vendorNumber, vendorData.vendorSourceSystemId, costCenters);
    ...
    it('should call costCenterIndex and call lastSelectedRow ', function () {
        Ctrl.gridApi = gridApi1;
        Ctrl.costCenters = {length: -1};
        Ctrl.lastSelectedRow = lastSelectedRow;
        spyOn(Ctrl, "costCenterIndex").and.callThrough();
        Ctrl.costCenterIndex(0);
        $scope.$apply();
        expect(Ctrl.costCenterIndex).toHaveBeenCalledWith(0);
        expect(Ctrl.lastSelectedRow).toEqual({isSelected: false});
    });

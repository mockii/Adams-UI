...
describe('LocationsCostCentersStatusChangeController', function () {
    var Ctrl,
    ...
    beforeEach(module('adams.locations.costcenters.status.change.controller'));
    ...
    beforeEach(inject(function ($controller, $rootScope, ADAMS_CONSTANTS) {
        ...
        Ctrl = $controller('LocationsCostCentersStatusChangeController', {
            $scope: $scope,
            $state: $state,
    ...
    it('should initialize the LocationsCostCentersStatusChangeController properly', function () {

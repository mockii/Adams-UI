...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            'node_modules/stgwebutils-client-libs/scripts/vendor/ui-grid*.js',
            'node_modules/stgwebutils-client-libs/scripts/templates/*.js',
            'dist/templates/*.js',
            'dist/scripts/ng-image-gallery/*.js',
        ...
        htmlReporter: {
            outputDir: 'karma-results/test-results-html'
        },
